import {
  ...
  useWillUnmount,
  useWindow
} from "./chunk-2P7ULYQN.js";
import {
  Button_default,
  Button_default2,
  useButtonProps
} from "./chunk-VGKWVEWL.js";
import {
  DEFAULT_BREAKPOINTS,
...
var Alert = React12.forwardRef((uncontrolledProps, ref) => {
  ...
  const alert = (0, import_jsx_runtime10.jsxs)("div", {
    ...
    ref,
    className: (0, import_classnames8.default)(className, prefix, variant && `${prefix}-${variant}`, dismissible && `${prefix}-dismissible`),
...
var Badge = React13.forwardRef(({
  ...
  return (0, import_jsx_runtime11.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames9.default)(className, prefix, pill && `rounded-pill`, text && `text-${text}`, bg && `bg-${bg}`)
  });
});
...
var BreadcrumbItem = React14.forwardRef(({
  bsPrefix,
  active = false,
  children,
  className,
  ...
  return (0, import_jsx_runtime12.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames10.default)(prefix, className, {
      active
    }),
...
var Breadcrumb = React15.forwardRef(({
  ...
  return (0, import_jsx_runtime13.jsx)(Component2, {
    ...
    children: (0, import_jsx_runtime13.jsx)("ol", {
      ...listProps,
      className: (0, import_classnames11.default)(prefix, listProps == null ? void 0 : listProps.className),
      children
    })
  });
});
...
var ButtonGroup = React16.forwardRef(({
  ...
  return (0, import_jsx_runtime14.jsx)(Component2, {
    ...
    ref,
    role,
    className: (0, import_classnames12.default)(className, baseClass, size && `${prefix}-${size}`)
  });
});
...
var CardImg = React18.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  ({
    bsPrefix,
    className,
...
var context3 = React19.createContext(null);
...
var Card = React21.forwardRef(({
  ...
  return (0, import_jsx_runtime18.jsx)(Component2, {
    ...
    children: body ? (0, import_jsx_runtime18.jsx)(CardBody, {
      children
    }) : children
  });
});
...
function useTimeout() {
  ...
  var handleRef = (0, import_react18.useRef)();
...
function map(children, func) {
  let index = 0;
  return React23.Children.map(children, (child) => React23.isValidElement(child) ? func(child, index++) : child);
}
function forEach(children, func) {
  let index = 0;
  React23.Children.forEach(children, (child) => {
    if (React23.isValidElement(child))
      func(child, index++);
  });
}
function hasChildOfType(children, type) {
  return React23.Children.toArray(children).some((child) => React23.isValidElement(child) && child.type === type);
}
    ...
    children: [indicators && (0, import_jsx_runtime20.jsx)("div", {
      ...
      children: map(children, (child, index) => {
        ...
        return slide ? (0, import_jsx_runtime20.jsx)(TransitionWrapper_default, {
          ...
          addEndListener: transitionEndListener,
          children: (status, innerProps) => React24.cloneElement(child, {
            ...innerProps,
...
function useForceUpdate() {
  var _useReducer = (0, import_react20.useReducer)(function(state) {
    return !state;
...
var DropdownContext = React26.createContext(null);
...
function useSafeState(state) {
  var isMounted = useMounted();
  return [state[0], (0, import_react21.useCallback)(function(nextState) {
    if (!isMounted())
      return;
...
function usePopper(referenceElement, popperElement, _ref = {}) {
  ...
  const prevModifiers = (0, import_react22.useRef)(modifiers);
  const popperInstanceRef = (0, import_react22.useRef)();
  const update = (0, import_react22.useCallback)(() => {
    var _popperInstanceRef$cu;
    (_popperInstanceRef$cu = popperInstanceRef.current) == null ? void 0 : _popperInstanceRef$cu.update();
  }, []);
  const forceUpdate = (0, import_react22.useCallback)(() => {
    var _popperInstanceRef$cu2;
    (_popperInstanceRef$cu2 = popperInstanceRef.current) == null ? void 0 : _popperInstanceRef$cu2.forceUpdate();
  }, []);
  const [popperState, setState] = useSafeState_default((0, import_react22.useState)({
    placement,
    update,
    forceUpdate,
    attributes: {},
  ...
  const updateModifier = (0, import_react22.useMemo)(() => ({
  ...
  const nextModifiers = (0, import_react22.useMemo)(() => {
...
function useClickOutside(ref, onClickOutside = noop, {
  ...
  const preventMouseClickOutsideRef = (0, import_react23.useRef)(false);
  const waitingForTrigger = (0, import_react23.useRef)(false);
  const handleMouseCapture = (0, import_react23.useCallback)((e) => {
...
function useDropdownMenu(options = {}) {
  const context6 = (0, import_react24.useContext)(DropdownContext_default);
  const [arrowElement, attachArrowRef] = useCallbackRef();
  const hasShownRef = (0, import_react24.useRef)(false);
  const {
    flip: flip2,
    offset: offset2,
    rootCloseEvent,
...
var $704cf1d3b684cc5c$var$SSRContext = (0, import_react25.default).createContext($704cf1d3b684cc5c$var$defaultContext);
function $704cf1d3b684cc5c$export$9f8ac96af4b1b2ae(props) {
  let cur = (0, import_react25.useContext)($704cf1d3b684cc5c$var$SSRContext);
  let counter = $704cf1d3b684cc5c$var$useCounter(cur === $704cf1d3b684cc5c$var$defaultContext);
  let [isSSR, setIsSSR] = (0, import_react25.useState)(true);
  ...
  return (0, import_react25.default).createElement($704cf1d3b684cc5c$var$SSRContext.Provider, {
    value
  }, props.children);
}
...
function $704cf1d3b684cc5c$var$useCounter(isDisabled = false) {
  let ctx = (0, import_react25.useContext)($704cf1d3b684cc5c$var$SSRContext);
  let ref = (0, import_react25.useRef)(null);
  if (ref.current === null && !isDisabled) {
    var _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED, _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED_ReactCurrentOwner;
    let currentOwner = (_React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = (0, import_react25.default).__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED) === null || _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED === void 0 ? void 0 : (_React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED_ReactCurrentOwner = _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner) === null || _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED_ReactCurrentOwner === void 0 ? void 0 : _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED_ReactCurrentOwner.current;
    if (currentOwner) {
...
function useDropdownToggle() {
  ...
  const {
    ...
    setToggle,
    menuElement
  } = (0, import_react26.useContext)(DropdownContext_default) || {};
  const handleClick = (0, import_react26.useCallback)((e) => {
    toggle(!show, e);
  }, [show, toggle]);
  const props = {
    id,
...
var SelectableContext = React29.createContext(null);
...
var NavContext = React30.createContext(null);
...
function useDropdownItem({
  ...
  const onSelectCtx = (0, import_react27.useContext)(SelectableContext_default);
  const navContext = (0, import_react27.useContext)(NavContext_default);
  const {
    activeKey
  } = navContext || {};
...
var DropdownItem = React31.forwardRef((_ref, ref) => {
  let {
    eventKey,
    disabled,
    onClick,
...
function useRefWithUpdate() {
  ...
  const attachRef = (0, import_react28.useCallback)((element) => {
    ref.current = element;
    forceUpdate();
  }, [forceUpdate]);
...
function Dropdown({
  ...
  const lastSourceEvent = (0, import_react28.useRef)(null);
  const focusInDropdown = (0, import_react28.useRef)(false);
  const onSelectCtx = (0, import_react28.useContext)(SelectableContext_default);
  const toggle = (0, import_react28.useCallback)((nextShow, event, source = event == null ? void 0 : event.type) => {
    onToggle(nextShow, {
      originalEvent: event,
      source
    });
  ...
  const context6 = (0, import_react28.useMemo)(() => ({
    toggle,
    placement,
    show,
    menuElement,
  ...
  useEventListener((0, import_react28.useCallback)(() => window2.document, [window2]), "keydown", (event) => {
...
var DropdownContext2 = React33.createContext({});
...
var DropdownItem2 = React34.forwardRef(({
  bsPrefix,
  className,
  eventKey,
  disabled = false,
...
var DropdownMenu2 = React37.forwardRef(({
  bsPrefix,
  className,
  align,
  rootCloseEvent,
...
var DropdownToggle2 = React38.forwardRef(({
  bsPrefix,
  split,
  className,
  childBsPrefix,
...
var Dropdown2 = React39.forwardRef((pProps, ref) => {
  const {
    bsPrefix,
    drop = "down",
    show,
...
var Feedback = React41.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  ({
    as: Component2 = "div",
    className,
...
var FormContext = React42.createContext({});
var FormContext_default = FormContext;

// node_modules/react-bootstrap/esm/FormCheckInput.js
var import_jsx_runtime37 = __toESM(require_jsx_runtime());
var FormCheckInput = React43.forwardRef(({
  id,
  bsPrefix,
  className,
  type = "checkbox",
...
var FormCheckLabel = React44.forwardRef(({
  bsPrefix,
  className,
  htmlFor,
  ...props
...
var FormCheck = React45.forwardRef(({
  id,
  bsPrefix,
  bsSwitchPrefix,
  inline = false,
  ...
  const innerFormContext = (0, import_react35.useMemo)(() => ({
...
var FormGroup = React47.forwardRef(({
  controlId,
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  as: Component2 = "div",
  ...props
...
var FormRange = React49.forwardRef(({
  bsPrefix,
  className,
  id,
  ...props
...
var FormSelect = React50.forwardRef(({
  bsPrefix,
  size,
  htmlSize,
  className,
  ...
  return (0, import_jsx_runtime46.jsx)("select", {
    ...
    size: htmlSize,
    ref,
    className: (0, import_classnames31.default)(className, bsPrefix, size && `${bsPrefix}-${size}`, isValid && `is-valid`, isInvalid && `is-invalid`),
    id: id || controlId
  });
});
...
var FormText = React51.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  ({
    bsPrefix,
    className,
...
var Switch = React52.forwardRef((props, ref) => (0, import_jsx_runtime48.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var FloatingLabel = React53.forwardRef(({
  bsPrefix,
  className,
  children,
  controlId,
...
var InputGroup = React58.forwardRef(({
  bsPrefix,
  size,
  hasValidation,
  className,
  ...
  return (0, import_jsx_runtime55.jsx)(InputGroupContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime55.jsx)(Component2, {
      ref,
      ...props,
      className: (0, import_classnames38.default)(className, bsPrefix, size && `${bsPrefix}-${size}`, hasValidation && "has-validation")
    })
  });
});
...
var TabContext = React59.createContext(null);
...
var NavItem = React60.forwardRef((_ref, ref) => {
  let {
    as: Component2 = Button_default,
    active,
    eventKey
...
var Nav = React61.forwardRef((_ref, ref) => {
  let {
    // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
    as: Component2 = "div",
    onSelect,
...
var ListGroupItem = React62.forwardRef(({
  bsPrefix,
  active,
  disabled,
  eventKey,
  ...
  return (0, import_jsx_runtime58.jsx)(Component2, {
    ...
    ...navItemProps,
    onClick: handleClick,
    className: (0, import_classnames39.default)(className, bsPrefix, meta.isActive && "active", disabled && "disabled", variant && `${bsPrefix}-${variant}`, action && `${bsPrefix}-action`)
  });
});
...
var ListGroup = React63.forwardRef((props, ref) => {
  const {
    className,
  ...
  return (0, import_jsx_runtime59.jsx)(Nav_default, {
    ...
    ...controlledProps,
    as,
    className: (0, import_classnames40.default)(className, bsPrefix, variant && `${bsPrefix}-${variant}`, horizontalVariant && `${bsPrefix}-${horizontalVariant}`, numbered && `${bsPrefix}-numbered`)
  });
});
...
var Nav2 = React65.forwardRef((uncontrolledProps, ref) => {
  const {
    as = "div",
    bsPrefix: initialBsPrefix,
    variant,
  ...
  let isNavbar = false;
  const navbarContext = (0, import_react44.useContext)(NavbarContext_default);
  const cardHeaderContext = (0, import_react44.useContext)(CardHeaderContext_default);
  if (navbarContext) {
...
var NavbarCollapse = React67.forwardRef(({
  ...
  const context6 = (0, import_react45.useContext)(NavbarContext_default);
  return (0, import_jsx_runtime63.jsx)(Collapse_default, {
...
var NavbarToggle = React68.forwardRef(({
  ...
  const {
    onToggle,
    expanded
  } = (0, import_react46.useContext)(NavbarContext_default) || {};
  ...
  return (0, import_jsx_runtime64.jsx)(Component2, {
    ...
    children: children || (0, import_jsx_runtime64.jsx)("span", {
...
function useMediaQuery(query, targetWindow) {
  ...
  var _useState = (0, import_react47.useState)(function() {
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    var query = (0, import_react48.useMemo)(function() {
...
var OffcanvasToggling = React69.forwardRef(({
  bsPrefix,
  className,
  children,
  in: inProp = false,
  ...
  return (0, import_jsx_runtime65.jsx)(TransitionWrapper_default, {
    ...
    ...props,
    childRef: children.ref,
    children: (status, innerProps) => React69.cloneElement(children, {
      ...innerProps,
      className: (0, import_classnames45.default)(className, children.props.className, (status === ENTERING || status === EXITING) && `${bsPrefix}-toggling`, transitionStyles[status])
    })
  });
});
...
var OffcanvasHeader = React70.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
...
function DialogTransition(props) {
  return (0, import_jsx_runtime67.jsx)(OffcanvasToggling_default, {
    ...props
  });
}
function BackdropTransition(props) {
  return (0, import_jsx_runtime67.jsx)(Fade_default, {
    ...props
  });
}
var Offcanvas = React71.forwardRef(({
  ...
  const modalManager = (0, import_react49.useRef)();
  bsPrefix = useBootstrapPrefix(bsPrefix, "offcanvas");
  const {
    onToggle
  } = (0, import_react49.useContext)(NavbarContext_default) || {};
  const [showOffcanvas, setShowOffcanvas] = (0, import_react49.useState)(false);
  ...
  const modalContext = (0, import_react49.useMemo)(() => ({
    onHide: handleHide
  }), [handleHide]);
  ...
  const renderBackdrop = (0, import_react49.useCallback)((backdropProps) => (0, import_jsx_runtime67.jsx)("div", {
    ...backdropProps,
    className: (0, import_classnames47.default)(`${bsPrefix}-backdrop`, backdropClassName)
  }), [backdropClassName, bsPrefix]);
  const renderDialog = (dialogProps) => (0, import_jsx_runtime67.jsx)("div", {
    ...dialogProps,
    ...props,
    className: (0, import_classnames47.default)(className, responsive ? `${bsPrefix}-${responsive}` : bsPrefix, `${bsPrefix}-${placement}`),
    "aria-labelledby": ariaLabelledby,
    children
  });
  return (0, import_jsx_runtime69.jsxs)(import_jsx_runtime68.Fragment, {
    children: [!showOffcanvas && (responsive || renderStaticNode) && renderDialog({}), (0, import_jsx_runtime67.jsx)(ModalContext_default.Provider, {
      value: modalContext,
      children: (0, import_jsx_runtime67.jsx)(Modal_default, {
        show: showOffcanvas,
        ref,
        backdrop,
        container,
...
var NavbarOffcanvas = React72.forwardRef((props, ref) => {
  const context6 = (0, import_react50.useContext)(NavbarContext_default);
  return (0, import_jsx_runtime70.jsx)(Offcanvas_default, {
    ref,
...
var Navbar = React73.forwardRef((props, ref) => {
  ...
  const handleCollapse = (0, import_react51.useCallback)((...args) => {
  ...
  const navbarContext = (0, import_react51.useMemo)(() => ({
  ...
  return (0, import_jsx_runtime71.jsx)(NavbarContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime71.jsx)(SelectableContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime71.jsx)(Component2, {
        ref,
        ...controlledProps,
        className: (0, import_classnames48.default)(className, bsPrefix, expand && expandClass, variant && `${bsPrefix}-${variant}`, bg && `bg-${bg}`, sticky && `sticky-${sticky}`, fixed && `fixed-${fixed}`)
      })
    })
  });
});
...
var NavDropdown = React74.forwardRef(({
  ...
  return (0, import_jsx_runtime73.jsxs)(Dropdown_default2, {
    ref,
    ...props,
    className: (0, import_classnames49.default)(className, navItemPrefix),
...
var Overlay = React75.forwardRef((props, outerRef) => {
  ...
  const [exited, setExited] = (0, import_react53.useState)(!props.show);
...
var Popover = React77.forwardRef(({
  bsPrefix,
  placement = "right",
  className,
  style,
  ...
  return (0, import_jsx_runtime75.jsxs)("div", {
    ...
    className: (0, import_classnames50.default)(className, decoratedBsPrefix, primaryPlacement && `bs-popover-${bsDirection}`),
    ...props,
    children: [(0, import_jsx_runtime74.jsx)("div", {
      className: "popover-arrow",
      ...arrowProps
    }), body ? (0, import_jsx_runtime74.jsx)(PopoverBody_default, {
      children
    }) : children]
  });
});
...
function useOverlayOffset(customOffset) {
  const overlayRef = (0, import_react54.useRef)(null);
  const popoverClass = useBootstrapPrefix(void 0, "popover");
  const offset2 = (0, import_react54.useMemo)(() => ({
    name: "offset",
    options: {
      offset: () => {
...
var Overlay2 = React78.forwardRef(({
  children: overlay,
  transition = Fade_default,
  popperConfig = {},
  rootClose = false,
  ...
  const popperRef = (0, import_react55.useRef)({});
  const [firstRenderedState, setFirstRenderedState] = (0, import_react55.useState)(null);
  ...
  return (0, import_jsx_runtime76.jsx)(Overlay_default, {
    ...outerProps,
    ref: mergedRef,
    popperConfig: {
      ...popperConfig,
    ...
    children: (overlayProps, {
      ...
      return React78.cloneElement(overlay, {
        ...overlayProps,
        placement: updatedPlacement,
        arrowProps,
        popper: popper2,
        hasDoneInitialMeasure,
        className: (0, import_classnames51.default)(overlay.props.className, !transition && show && "show"),
        style: {
          ...overlay.props.style,
          ...overlayProps.style
        }
...
function OverlayTrigger({
  ...
  const triggerNodeRef = (0, import_react56.useRef)(null);
  const mergedRef = useMergedRefs_default(triggerNodeRef, children.ref);
  const timeout = useTimeout();
  const hoverStateRef = (0, import_react56.useRef)("");
  ...
  const {
    ...
    onBlur,
    onClick
  } = typeof children !== "function" ? React79.Children.only(children).props : {};
  const attachRef = (r) => {
    mergedRef(safeFindDOMNode(r));
  };
  const handleShow = (0, import_react56.useCallback)(() => {
    timeout.clear();
  ...
  const handleHide = (0, import_react56.useCallback)(() => {
    timeout.clear();
  ...
  const handleFocus = (0, import_react56.useCallback)((...args) => {
    handleShow();
    onFocus == null ? void 0 : onFocus(...args);
  }, [handleShow, onFocus]);
  const handleBlur = (0, import_react56.useCallback)((...args) => {
    handleHide();
    onBlur == null ? void 0 : onBlur(...args);
  }, [handleHide, onBlur]);
  const handleClick = (0, import_react56.useCallback)((...args) => {
    setShow(!show);
    onClick == null ? void 0 : onClick(...args);
  }, [onClick, setShow, show]);
  const handleMouseOver = (0, import_react56.useCallback)((...args) => {
    handleMouseOverOut(handleShow, args, "fromElement");
  }, [handleShow]);
  const handleMouseOut = (0, import_react56.useCallback)((...args) => {
  ...
  return (0, import_jsx_runtime79.jsxs)(import_jsx_runtime78.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react56.cloneElement)(children, triggerProps), (0, import_jsx_runtime77.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
var PageItem = React80.forwardRef(({
  ...
  return (0, import_jsx_runtime80.jsx)("li", {
    ref,
    style,
    className: (0, import_classnames52.default)(className, "page-item", {
      active,
      disabled
    }),
    children: (0, import_jsx_runtime81.jsxs)(Component2, {
      className: "page-link",
      ...props,
      children: [children, active && activeLabel && (0, import_jsx_runtime80.jsx)("span", {
        className: "visually-hidden",
...
function createButton(name, defaultValue, label = name) {
  const Button = React80.forwardRef(({
    children,
    ...props
  }, ref) => (0, import_jsx_runtime81.jsxs)(PageItem, {
    ...props,
    ref,
    children: [(0, import_jsx_runtime80.jsx)("span", {
      "aria-hidden": "true",
...
var Pagination = React81.forwardRef(({
  bsPrefix,
  className,
  size,
  ...props
  ...
  return (0, import_jsx_runtime82.jsx)("ul", {
    ref,
    ...props,
    className: (0, import_classnames53.default)(className, decoratedBsPrefix, size && `${decoratedBsPrefix}-${size}`)
  });
});
...
function usePlaceholder({
  ...
  return {
    ...colProps,
    className: (0, import_classnames54.default)(className, animation ? `${bsPrefix}-${animation}` : bsPrefix, size && `${bsPrefix}-${size}`, bg && `bg-${bg}`)
  };
}
...
var PlaceholderButton = React82.forwardRef((props, ref) => {
  const placeholderProps = usePlaceholder(props);
  return (0, import_jsx_runtime83.jsx)(Button_default2, {
    ...placeholderProps,
    ref,
    disabled: true,
    tabIndex: -1
...
var Placeholder = React83.forwardRef(({
  as: Component2 = "span",
  ...props
}, ref) => {
  const placeholderProps = usePlaceholder(props);
...
function renderProgressBar({
  ...
  return (0, import_jsx_runtime85.jsx)("div", {
    ...
    ...props,
    role: "progressbar",
    className: (0, import_classnames55.default)(className, `${bsPrefix}-bar`, {
      [`bg-${variant}`]: variant,
    ...
    "aria-valuemin": min2,
    "aria-valuemax": max2,
    children: visuallyHidden ? (0, import_jsx_runtime85.jsx)("span", {
      className: "visually-hidden",
      children: label
    }) : label
  });
}
var ProgressBar = React84.forwardRef(({
  isChild = false,
  ...rest
}, ref) => {
  const props = {
  ...
  return (0, import_jsx_runtime85.jsx)("div", {
    ...
    children: children ? map(children, (child) => (0, import_react57.cloneElement)(child, {
      isChild: true
    })) : renderProgressBar({
      min: min2,
      now,
...
var Ratio = React85.forwardRef(({
  ...
  return (0, import_jsx_runtime86.jsx)("div", {
    ...
    className: (0, import_classnames56.default)(bsPrefix, className, !isCustomRatio && `${bsPrefix}-${aspectRatio}`),
    children: React85.Children.only(children)
  });
});
...
var Row = React86.forwardRef(({
  ...
  return (0, import_jsx_runtime87.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames57.default)(className, decoratedBsPrefix, ...classes)
  });
});
Row.displayName = "Row";
var Row_default = Row;
...
var Spinner = React87.forwardRef(({
  bsPrefix,
  variant,
  animation = "border",
  size,
  ...
  return (0, import_jsx_runtime88.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames58.default)(className, bsSpinnerPrefix, size && `${bsSpinnerPrefix}-${size}`, variant && `text-${variant}`)
  });
});
...
var SplitButton = React88.forwardRef(({
  id,
  bsPrefix,
  size,
  variant,
  ...
  flip: flip2,
  ...props
}, ref) => (0, import_jsx_runtime90.jsxs)(Dropdown_default2, {
  ref,
  ...props,
  as: ButtonGroup_default,
  children: [(0, import_jsx_runtime89.jsx)(Button_default2, {
    size,
    variant,
    ...
    type,
    children: title
  }), (0, import_jsx_runtime89.jsx)(Dropdown_default2.Toggle, {
    split: true,
    id,
    size,
    variant,
...
var Stack = React89.forwardRef(({
  ...
  return (0, import_jsx_runtime91.jsx)(Component2, {
    ...props,
    ref,
    className: (0, import_classnames59.default)(className, bsPrefix, ...createUtilityClassName({
      gap
...
function useTabPanel(_ref) {
  ...
  const context6 = (0, import_react58.useContext)(TabContext_default);
  if (!context6)
...
var TabPanel = React90.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  (_ref2, ref) => {
    let {
      as: Component2 = "div"
    ...
    return (0, import_jsx_runtime92.jsx)(TabContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime92.jsx)(SelectableContext_default.Provider, {
        ...
        children: (0, import_jsx_runtime92.jsx)(Transition, {
          ...
          mountOnEnter,
          unmountOnExit,
          children: (0, import_jsx_runtime92.jsx)(Component2, Object.assign({}, tabPanelProps, {
            ref,
            hidden: !isActive,
...
var Tabs = (props) => {
  ...
  const generateChildId = (0, import_react59.useMemo)(() => generateCustomChildId || ((key, type) => id ? `${id}-${type}-${key}` : null), [id, generateCustomChildId]);
  const tabContext = (0, import_react59.useMemo)(() => ({
    onSelect,
    activeKey,
    transition,
...
var TabContainer = ({
  transition,
  ...props
}) => (0, import_jsx_runtime94.jsx)(Tabs_default, {
  ...props,
...
var TabPane = React93.forwardRef(({
  bsPrefix,
  transition,
  ...props
}, ref) => {
  ...
  return (0, import_jsx_runtime95.jsx)(TabContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime95.jsx)(SelectableContext_default.Provider, {
      value: null,
      children: (0, import_jsx_runtime95.jsx)(Transition, {
        in: isActive,
        onEnter,
        onEntering,
        onEntered,
        ...
        children: (0, import_jsx_runtime95.jsx)(Component2, {
          ...rest,
          ref,
          className: (0, import_classnames60.default)(className, prefix, isActive && "active")
        })
      })
    })
  });
...
var Tab = () => {
  ...
  return (0, import_jsx_runtime97.jsx)(import_jsx_runtime96.Fragment, {});
};
...
var Table = React95.forwardRef(({
  ...
  const classes = (0, import_classnames61.default)(className, decoratedBsPrefix, variant && `${decoratedBsPrefix}-${variant}`, size && `${decoratedBsPrefix}-${size}`, striped && `${decoratedBsPrefix}-${typeof striped === "string" ? `striped-${striped}` : "striped"}`, bordered && `${decoratedBsPrefix}-bordered`, borderless && `${decoratedBsPrefix}-borderless`, hover && `${decoratedBsPrefix}-hover`);
  const table = (0, import_jsx_runtime98.jsx)("table", {
    ...props,
    className: classes,
    ref
  });
...
function renderTab(child) {
  ...
  return (0, import_jsx_runtime99.jsx)(NavItem_default2, {
    as: "li",
    role: "presentation",
    children: (0, import_jsx_runtime99.jsx)(NavLink_default, {
      as: "button",
      type: "button",
      eventKey,
      disabled,
...
var Tabs2 = (props) => {
  ...
  return (0, import_jsx_runtime100.jsxs)(Tabs_default, {
    id,
    activeKey,
    onSelect,
    transition: getTabTransitionComponent(transition),
    mountOnEnter,
    unmountOnExit,
    children: [(0, import_jsx_runtime99.jsx)(Nav_default2, {
      ...controlledProps,
      role: "tablist",
      as: "ul",
      variant,
      children: map(children, renderTab)
    }), (0, import_jsx_runtime99.jsx)(TabContent_default, {
      children: map(children, (child) => {
        ...
        return (0, import_jsx_runtime99.jsx)(TabPane_default, {
          ...childProps
        });
      })
    })]
...
var ToastFade = React97.forwardRef((props, ref) => (0, import_jsx_runtime101.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastContext = React98.createContext({
...
var ToastHeader = React99.forwardRef(({
  bsPrefix,
  closeLabel = "Close",
  closeVariant,
  closeButton = true,
  ...
  const context6 = (0, import_react60.useContext)(ToastContext_default);
  const handleClick = useEventCallback((e) => {
  ...
  return (0, import_jsx_runtime103.jsxs)("div", {
    ref,
    ...props,
    className: (0, import_classnames62.default)(bsPrefix, className),
    children: [children, closeButton && (0, import_jsx_runtime102.jsx)(CloseButton_default, {
      "aria-label": closeLabel,
      variant: closeVariant,
      onClick: handleClick,
      "data-dismiss": "toast"
...
var Toast = React100.forwardRef(({
  ...
  const delayRef = (0, import_react61.useRef)(delay);
  const onCloseRef = (0, import_react61.useRef)(onClose);
  ...
  const autohideFunc = (0, import_react61.useCallback)(() => {
    if (autohideToast) {
  ...
  const toastContext = (0, import_react61.useMemo)(() => ({
    onClose
  }), [onClose]);
  const hasAnimation = !!(Transition && animation);
  const toast = (0, import_jsx_runtime104.jsx)("div", {
    ...props,
    ref,
    className: (0, import_classnames63.default)(bsPrefix, className, bg && `bg-${bg}`, !hasAnimation && (show ? "show" : "hide")),
    role: "alert",
    "aria-live": "assertive",
    "aria-atomic": "true"
  });
  return (0, import_jsx_runtime104.jsx)(ToastContext_default.Provider, {
    value: toastContext,
    children: hasAnimation && Transition ? (0, import_jsx_runtime104.jsx)(Transition, {
      in: show,
      unmountOnExit: true,
      children: toast
    }) : toast
...
var ToastContainer = React101.forwardRef(({
  bsPrefix,
  position,
  containerPosition,
  className,
  ...
  return (0, import_jsx_runtime105.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames64.default)(bsPrefix, position && positionClasses[position], containerPosition && `position-${containerPosition}`, className)
  });
});
...
var noop6 = () => void 0;
var ToggleButton = React102.forwardRef(({
  bsPrefix,
  name,
  className,
  checked,
  ...
  return (0, import_jsx_runtime108.jsxs)(import_jsx_runtime107.Fragment, {
    children: [(0, import_jsx_runtime106.jsx)("input", {
      className: bsPrefix,
      name,
      type,
      value,
      ...
      id
    }), (0, import_jsx_runtime106.jsx)(Button_default2, {
      ...props,
      ref,
      className: (0, import_classnames65.default)(className, disabled && "disabled"),
      type: void 0,
      role: void 0,
      as: "label",
      htmlFor: id
...
var ToggleButtonGroup = React103.forwardRef((props, ref) => {
  const {
    children,
    type = "radio",
    name,
  ...
  return (0, import_jsx_runtime109.jsx)(ButtonGroup_default, {
    ...controlledProps,
    ref,
    vertical,
    children: map(children, (child) => {
      ...
      return React103.cloneElement(child, {
        type,
...
var Tooltip = React104.forwardRef(({
  ...
  return (0, import_jsx_runtime111.jsxs)("div", {
    ...
    role: "tooltip",
    "x-placement": primaryPlacement,
    className: (0, import_classnames66.default)(className, bsPrefix, `bs-tooltip-${bsDirection}`),
    ...props,
