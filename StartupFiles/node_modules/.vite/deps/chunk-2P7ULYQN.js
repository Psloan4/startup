...
var TransitionGroupContext_default = import_react15.default.createContext(null);
...
var Transition = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return (
      ...
      import_react16.default.createElement(TransitionGroupContext_default.Provider, {
        value: null
      }, typeof children === "function" ? children(status, childProps) : import_react16.default.cloneElement(import_react16.default.Children.only(children), childProps))
    );
  };
  return Transition2;
...
function createWithBsPrefix(prefix, {
  ...
  const BsComponent = React7.forwardRef(({
    className,
    bsPrefix,
    ...
    return (0, import_jsx_runtime7.jsx)(Tag, {
      ref,
...
var ModalDialog = React9.forwardRef(({
  bsPrefix,
  className,
  contentClassName,
  centered,
...
var AbstractModalHeader = React11.forwardRef(({
  ...
  const context = (0, import_react19.useContext)(ModalContext_default);
...
function DialogTransition(props) {
  return (0, import_jsx_runtime14.jsx)(Fade_default, {
    ...props,
    timeout: null
  });
}
...
var Modal2 = React14.forwardRef(({
  ...
  const [modalStyle, setStyle] = (0, import_react20.useState)({});
  const [animateStaticModal, setAnimateStaticModal] = (0, import_react20.useState)(false);
  const waitingForMouseUpRef = (0, import_react20.useRef)(false);
  const ignoreBackdropClickRef = (0, import_react20.useRef)(false);
  const removeStaticModalAnimationRef = (0, import_react20.useRef)(null);
  const [modal, setModalRef] = useCallbackRef();
  const mergedRef = useMergedRefs_default(ref, setModalRef);
  const handleHide = useEventCallback(onHide);
  const isRTL = useIsRTL();
  bsPrefix = useBootstrapPrefix(bsPrefix, "modal");
  const modalContext = (0, import_react20.useMemo)(() => ({
    onHide: handleHide
  }), [handleHide]);
  ...
  const renderBackdrop = (0, import_react20.useCallback)((backdropProps) => (0, import_jsx_runtime14.jsx)("div", {
    ...backdropProps,
  ...
  const renderDialog = (dialogProps) => (0, import_jsx_runtime14.jsx)("div", {
    role: "dialog",
    ...dialogProps,
    style: baseModalStyle,
    className: (0, import_classnames7.default)(className, bsPrefix, animateStaticModal && `${bsPrefix}-static`, !animation && "show"),
    onClick: backdrop ? handleClick : void 0,
    onMouseUp: handleMouseUp,
    "aria-label": ariaLabel,
    "aria-labelledby": ariaLabelledby,
    "aria-describedby": ariaDescribedby,
    children: (0, import_jsx_runtime14.jsx)(Dialog, {
      ...props,
  ...
  return (0, import_jsx_runtime14.jsx)(ModalContext_default.Provider, {
    value: modalContext,
    children: (0, import_jsx_runtime14.jsx)(Modal_default, {
      show,
      ref: mergedRef,
      backdrop,
      container,
...
object-assign/index.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-2P7ULYQN.js.map
